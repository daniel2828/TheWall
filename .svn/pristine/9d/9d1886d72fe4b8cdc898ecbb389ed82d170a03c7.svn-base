<%@ Page Language="C#" AutoEventWireup="true" CodeFile="error.aspx.cs" Inherits="login" EnableEventValidation="false" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <fieldset>
                        ...
                        <asp:Button ID="btLogin" runat="server" Text="Home" OnClick="btLogin_Click" class="btn btn-lg btn-red btn-block animation"  />
                    </fieldset>
                    </form>
                </div>
            </div>
